...
export default function PrivacySection() {
  ...
  const handleAccountDeletion = async () => {
    ...
    try {
      ...
      setDeleteSuccess(
        "Votre compte a été supprimé avec succès. Vous serez redirigé vers la page d'accueil.",
      );
    ...
    <section className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow space-y-8">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            {' '}
            Dans le cadre de notre application de gestion de véhicules, nous collectons les données
            suivantes :{' '}
          </p>
          <ul className="space-y-2 text-gray-600 dark:text-gray-400 list-disc list-inside">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-4">
            ...
            Ces données sont utilisées uniquement pour vous fournir le service de suivi de
            consommation et de gestion de votre parc automobile.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            divulgation non autorisée ou l&apos;accès accidentel.
          </p>
          <ul className="space-y-2 text-gray-600 dark:text-gray-400 list-disc list-inside">
        ...
        <div className="border-t border-gray-200 pt-6">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            Vous pouvez exporter toutes vos données personnelles au format JSON pour les conserver
            ou les transférer vers un autre service.
          </p>
          <button
          ...
          {exportSuccess && (
            <div
              className={`p-3 rounded-lg text-sm mt-3 ${exportSuccess.includes('Erreur') ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'}`}
            >
              {exportSuccess}
            </div>
          )}
        ...
        <div className="border-t border-gray-200 pt-6">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            Vous pouvez supprimer définitivement votre compte et toutes vos données associées. Cette
          ...
          <div className="bg-red-50 dark:bg-red-900/10 p-4 rounded-lg border border-red-200 dark:border-red-800 mb-4 flex items-start gap-3">
            <p className="text-sm text-red-700 dark:text-red-300 font-medium">
              ...
              (véhicules, historique de consommation, etc.). Cette action ne peut pas être annulée.
            </p>
          </div>
          <button
          ...
          {deleteSuccess && (
            <div
              className={`p-3 rounded-lg text-sm mt-3 ${deleteSuccess.includes('Erreur') ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'}`}
            >
              {deleteSuccess}
            </div>
          )}
            ...
            <div className="mt-4 p-4 bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-900 dark:border-gray-700">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  disabled={deletingAccount}
                  className={`flex-1 px-4 py-2 rounded-lg font-medium transition-colors text-white hover:cursor-pointer ${deletingAccount ? 'bg-red-400 cursor-not-allowed' : 'bg-red-600 hover:bg-red-700'}`}
                >
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
          ...
          <ul className="list-disc list-inside mt-2 text-gray-600 dark:text-gray-400 space-y-1">
            <li>
              {' '}
              <strong>Vercel Inc.</strong> - Hébergement du site web et gestion du nom de
              domaine{' '}
            </li>
            <li>
              {' '}
              <strong>Supabase Inc.</strong> - Authentification et stockage sécurisé des
              données{' '}
            </li>
          </ul>
          <p className="text-gray-600 dark:text-gray-400 mt-3 text-sm">
            Ces prestataires agissent en tant que sous-traitants au sens du RGPD et mettent en œuvre
            des mesures de sécurité conformes aux standards européens.
          </p>
        </div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            En utilisant notre application, vous consentez au traitement de vos données personnelles
            conformément à notre politique de confidentialité. Vous pouvez retirer votre
            consentement à tout moment en supprimant votre compte.
          </p>
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            <strong>Durée de conservation :</strong> Vos données sont conservées aussi longtemps que
            votre compte est actif, sauf demande explicite de suppression.
          </p>
        </div>
      </div>
    </section>
